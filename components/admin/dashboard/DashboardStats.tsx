...
import { Users, Scissors, Building2, UserCheck2, Video, Clock, CalendarCheck, ShoppingBag, DollarSign, Wallet, TrendingUp, MapPin } from "lucide-react";
...
const statsRows = [
  [
    ...
    { title: "Street Agents", value: "342", change: "+9.5% vs last month", positive: true, icon: MapPin, iconColor: "text-[#F97316]", iconBg: "bg-[#FFF7ED]" },
  ],
  [
    { title: "Video Queue", value: "23", change: "+5 today vs last month", positive: true, icon: Video, iconColor: "text-[#7C3AED]", iconBg: "bg-[#F3F0FF]" },
    { title: "Pending Vendors", value: "2", change: "Needs review vs last month", positive: false, icon: Clock, iconColor: "text-[#0EA5E9]", iconBg: "bg-[#F0F9FF]" },
    ...
    { title: "Today's Orders", value: "47", change: "+31.2% vs last month", positive: true, icon: ShoppingBag, iconColor: "text-[#F97316]", iconBg: "bg-[#FFF7ED]" },
  ],
  [
    ...
    { title: "Escrow Balance", value: "$12,840", change: "-2.1% vs last month", positive: false, isError: true, icon: Wallet, iconColor: "text-[#EF4444]", iconBg: "bg-[#FFF1F2]" },
    { title: "Vendor Revenue", value: "$24,490", change: "+28.4% vs last month", positive: true, icon: TrendingUp, iconColor: "text-[#10B981]", iconBg: "bg-[#F0FDF4]" },
    { title: "Street Agents", value: "$48,392", change: "+10.5% vs last month", positive: true, icon: MapPin, iconColor: "text-[#7C3AED]", iconBg: "bg-[#F3F0FF]" },
  ],
];
