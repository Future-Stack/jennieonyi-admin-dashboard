...
export function ConfirmApproveModal({ vendor, onClose, onConfirm }: ConfirmApproveModalProps) {
  return (
    <div 
        ...
        <div className="p-[20px]">
          <div className="bg-[#FFFBEB] rounded-[14px] p-4 flex items-start gap-3 mb-5">
            ...
            <p className="text-[14px] text-[#92400E] leading-relaxed">
              Are you sure you want to <span className="font-bold">Approve<br/>{vendor.name.split(' ')[0]} {vendor.name.split(' ')[1] || ''}?</span>
            </p>
          </div>
